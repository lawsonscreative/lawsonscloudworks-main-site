...
export default function ProductisedOffer({
  ...
  const contentSection = (
    <div className="space-y-8">
      ...
      <div className="bg-white border-2 border-brand-navy/10 rounded-lg p-6 space-y-6">
        <h3 className="text-2xl font-semibold text-brand-navy">
          {offerTitle}
        </h3>

        <div>
          <h4 className="text-lg font-semibold text-brand-navy mb-3">Who it&apos;s for:</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-brand-navy mb-3">What we do:</h4>
          <ul className="space-y-2">
        ...
        <div>
          <h4 className="text-lg font-semibold text-brand-navy mb-3">What you get:</h4>
          <ul className="space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-neutral-200">
          <div>
            ...
            <p className="text-brand-navy font-semibold">{duration}</p>
          </div>
          <div>
            <p className="text-sm font-semibold text-neutral-600 mb-1">Investment:</p>
            <p className="text-brand-navy font-semibold">{investment}</p>
          </div>
        </div>
      ...
      {securityNote && (
        <div className="bg-brand-light/30 border-l-4 border-brand-sky rounded-r-lg p-6">
