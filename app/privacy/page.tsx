          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <div className="bg-neutral-50 p-6 rounded-lg mt-8">
              <p className="text-sm text-neutral-600 mb-0">
                <strong>Note:</strong> This is a basic privacy policy suitable for a consultancy website.
                For production use, you should have this reviewed by a legal professional to ensure it
                meets all UK GDPR requirements.
              </p>
            </div>
          </div>
        </div>
